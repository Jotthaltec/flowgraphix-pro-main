-- Corrige store.publish_crm_product: variacoes manuais (variation_rows) e eixos
-- detectados estavam gravando o ajuste de preco como modifier_type='percentual'
-- calculado sobre um preco-base incompativel, produzindo valores absurdos no
-- site (ex.: -71,5686% em vez do desconto real de -R$0,73). Passa a gravar
-- sempre 'fixo' com o delta real entre o preco da opcao e o preco-base, que e
-- exatamente o que o CRM tem configurado.
--
-- Aplicado em produção (projeto PrintFlow CRM) em 2026-08-22 22:27:36 UTC via
-- apply_migration; este arquivo apenas versiona o mesmo CREATE OR REPLACE que
-- já está rodando no banco remoto, para eliminar o drift entre repo e banco.
